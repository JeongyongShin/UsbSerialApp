...
public class DevicesFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("App-Serial", "onCreate( ) ...   @DeviceFragment.java " );
    ...
    public void onResume() {
        Log.i("App-Serial", "onResume( ) ...   @DeviceFragment.java " );
        super.onResume();
        refresh();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.refresh) {
            Log.i("App-Serial", "onOptionsItemSelected( ) --> R.id.refresh   @DeviceFragment.java " );
            refresh();
            return true;
            ...
            Log.i("App-Serial", "onOptionsItemSelected( ) --> R.id.baud_rate   @DeviceFragment.java , baudRate : " +baudRate);
            builder.create().show();
            return true;
            ...
            Log.i("App-Serial", "onOptionsItemSelected( ) --> R.id.read_mode   @DeviceFragment.java , values : " +values);
    ...
    void refresh() {
        ...
        for(UsbDevice device : usbManager.getDeviceList().values()) {
            ...
            Log.i("App-Serial", "refresh( ) --> for loop...  --> driver  : " + driver);
            if(driver == null) {
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        if(item.driver == null) {
            ...
            Log.i("App-Serial", "onListItemClick( )  device  : " + item.device.getDeviceId()+ ", port : " + item.port+ ", baud : " +baudRate + ", position : " +position);
        }
    }
